...
cortex_a8 = Entry(speed="600MHz", policy="random", l1_size=2**15, l2_size=2**18, predictor="tournament", btb_entries=512, ras_size=8, global_buffer=512, local_buffer=1)
cortex_a9 = Entry(speed="1GHz", policy="random", l1_size=2**15, l2_size=2**19, predictor="tournament", btb_entries=4096, ras_size=8, global_buffer=4096, local_buffer=1)
...
stm32mp1 = Entry(speed="650MHz", policy="random", l1_size=2**15, l2_size=2**18, predictor="tournament", btb_entries=8, ras_size=8, global_buffer=256, local_buffer=1)
...
stm32h7 = Entry(speed="550MHz", policy="random", l1_size=2**15, l2_size=0, predictor="tournament", btb_entries=1, ras_size=1, global_buffer=1, local_buffer=1)
