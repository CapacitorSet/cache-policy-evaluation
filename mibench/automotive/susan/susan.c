...
#endif
#else
  if ((fd=fmemopen(mibench_automotive_susan_input_small_pgm, mibench_automotive_susan_input_small_pgm_len, "r")) == NULL)
#endif
...
{
  */
char *argv[] = {"", "/home/jules/sanchez/mibench/automotive/susan/input_small.pgm", "/tmp/mibench-output.pgm"};
int argc = 3;
int main() {
/* {{{ vars */
